...
import com.elementRepository.ProjectDetailsPage;
...
public class stepDefinitionForBuy {
	...
	public void user_should_be_able_to_click_on_login_button_and_navigate_to_the_login_page() throws Exception {
		loginPage=homePage.clickOLoginButton(driver);
		Thread.sleep(3000);
	...
	public void user_should_be_able_to_click_on_continue() throws InterruptedException {
		homePage=loginPage.clickOnContinueLink(driver);
	...
	public void user_should_be_able_to_mouse_hover_on_shortlist_button_and_click_on_view_your_shortlisted_properties_link() throws Exception {
	...
	@Then("user should be able to click on the question and view the answers")
	public void user_should_be_able_to_click_on_the_question_and_view_the_answers() throws InterruptedException {
		...
		Reporter.log("user is able to click on qustion and view the answer", true);
	}
	...
	///Property Details Page
		...
		public void user_should_be_able_to_click_on_property_name_link_and_navigate_to_the_property_details_page() {
		    ...
		    webDriverUtility.switchToTabOnTitle(driver, budgetHomesPage.getPropertyNameLink().getText());
		}
